...
public class SimpleTest{
    ...
    public static void simpleTest(){
        ...
        map = new SimpleHashMap<Integer, Integer>(11, SimpleHashMap.CollisionStrategy.QUADRATIC_PROBING);
    ...
    public static void capacityTest(){
        ...
        map = new SimpleHashMap<Integer, Integer>(initialCapacity, SimpleHashMap.CollisionStrategy.QUADRATIC_PROBING);
...
//        }
    ...
    public static void loadTest(){
        ...
        map = new SimpleHashMap<Integer, Integer>(loadFactor, SimpleHashMap.CollisionStrategy.QUADRATIC_PROBING);
